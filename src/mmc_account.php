...
<html>
    ...
    <!-- HEADER PART -->
        ...
        <link rel="stylesheet" type="text/css" href="../css/mmc_account.css">
    </head>
    <body>
        <br>
        ...
        <br><br><br>
        <center>
        <form method="post" action="mmc_account.php" id="saveaccountform">
            <div id="bar">
            <table>
            <tr>
                <th>Serial No.&nbsp;</th>
            ...
            <?php
            $get_data = "SELECT * FROM accountmmc";
        ...
        <br><br>
        <button type="submit" name="save_account" id="save_but">Save changes</button>
        </form> 
        </center>
    </body>
</html>